import React, {
  ...
  // ---------- Internal Hook ----------
  function useCircuitStateInternal() {
    ...
    const getProteinData = useCallback(
      (label: string) => proteins[label] ?? null,
      [proteins]
    );
  ...
  export const useCircuitContext = (): CircuitState => {
